...
export function buildZoomableSunburstChart(
	...
	const colour = scaleOrdinal(["rgb(254, 232, 178)", "rgb(225, 190, 190)", "rgb(187, 206, 178)", "rgb(179, 218, 241)", "rgb(193, 179, 142)"]);
	const colour2 = scaleOrdinal(["rgb(255, 198, 0)", "rgb(255, 85, 17)" , "rgb(73, 21, 68)", "rgb(39, 118, 71)", "rgb(0, 80, 134)"]);
